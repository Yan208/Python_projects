...
class FolderMenu(Screen):
  ...
  def send_folder_menu(self):
      pfolder.PopupCreateFolder.receive_self_folder_menu_in_popup_cr_folder(self, self_folder)
    
  def receive_self_testapp_in_folder_menu(self, self_testapp):
      global folder_testapp
      folder_testapp = self_testapp
  ...
  def redraw_file(self):
    ...
    folder_testapp.sm.current = 'menu_file'
